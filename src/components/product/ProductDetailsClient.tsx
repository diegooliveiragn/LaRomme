...
import { Check, ShieldCheck, Truck, RefreshCw, ChevronDown, ArrowRight } from 'lucide-react';
...
export function ProductDetailsClient({ product }: ProductDetailsClientProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
      {/* Galeria / Display do Produto (AnimatePresence para transição de cores) */}
      <div className="lg:col-span-7 space-y-4 sticky top-28">
        <div className="aspect-[3/4] bg-white border border-zinc-200 p-8 sm:p-12 flex flex-col justify-center items-center text-center relative overflow-hidden shadow-sm">
          <AnimatePresence mode="wait">
            ...
            >
              <span className="text-xs font-bold uppercase tracking-editorial text-brand-red">
                {product.subtitle}
              </span>
      ...
      >
        <div>
          <span className="text-[10px] uppercase font-bold tracking-editorial text-brand-red block mb-1">
        ...
        {/* Accordions Editoriais de Especificação */}
